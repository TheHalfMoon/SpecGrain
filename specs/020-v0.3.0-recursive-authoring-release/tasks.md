...
- [ ] T014 Record exact implementation/review/merge/publication evidence and run a fresh post-v0.3 product audit.
- [ ] T015 Close 020 through a documentation-only exact-head PR, expected-head merge, canonical post-closeout CI, and historical `v0.3.0` no-mutation Release verification before claiming `CLOSED_CANONICAL`.
