# Tasks 013 — Spec Kit Import

## Planning

- [x] T001 Re-read canonical `main` at `1243cc584da718e6eb986b576b09777ff5a0056e`, execution plan, migration direction, and live `github/spec-kit` templates.
- [x] T002 Close Specification 012 from PR #14 exact-head/post-merge evidence.
- [x] T003 Record ADR-0013 bounded explicit Spec Kit migration.
- [x] T004 Define source artifact, conversion report, partial-mapping notice, and legacy-task boundaries.
