# Tasks 011 — Method Profiles

## Planning

- [x] T001 Re-read canonical `main` at `fa666854324aa131d6232df0bbb5971c0498f76e`, methodology, roadmap, 004 readiness, and 009–010 contracts.
- [x] T002 Close Specification 010 canonical task state from PR #12 exact-head/post-merge evidence.
- [x] T003 Record ADR-0011 lightweight composable method profiles.
- [x] T004 Define canonical profiles and bounded metadata/evidence requirements.
...
- [ ] T016 Merge only with expected-head evidence, re-read canonical `main`, then begin 012.
